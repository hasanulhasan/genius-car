    ...
    <div className="hero my-16">
      <div className="hero-content flex-col lg:flex-row">
        <div className='w-1/2 relative'>
          ...
          <img src={parts} alt='..' className="absolute w-3/5 right-5 top-1/2 border-8 border-stone-500 rounded-lg shadow-2xl" />
        </div>
        <div className='w-1/2'>
          <h1 className="text-2xl pb-2 font-bold text-orange-600">About Us</h1>
